...
const podocarpo = {
  ...
  image: "./floreios/pod01.jpg",
  googleImage: "https://www.google.com/search?q=Podocarpus+macrophyllus&rlz=1C1CHZN_pt-BRBR1019BR1019&hl=pt-BR&source=lnms&tbm=isch&sa=X&ved=2ahUKEwiemq_visL8AhV6s5UCHf-5CUEQ_AUoAXoECAEQAw&biw=533&bih=959&dpr=1",
};
...
const rafia = {
  ...
  shadePlant: true,
  partialShadePlant: true,
  image: "./floreios/raf01.jpg",
  googleImage: "https://www.google.com/search?q=Rhapis+excelsa&rlz=1C1CHZN_pt-BRBR1019BR1019&source=lnms&tbm=isch&sa=X&ved=2ahUKEwi2ydiRi8L8AhVRuZUCHVujCf8Q_AUoAXoECAEQAw&biw=958&bih=959&dpr=1",
};
...
const dracena = {
  ...
  shadePlant: false,
  partialShadePlant: true,
  image: "./floreios/dra01.jpg",
  googleImage: "https://www.google.com/search?q=Cordyline+fruticosa&tbm=isch&ved=2ahUKEwiu7NiSi8L8AhXJN7kGHXDWARYQ2-cCegQIABAA&oq=Cordyline+fruticosa&gs_lcp=CgNpbWcQAzIFCAAQgAQyBQgAEIAEMgUIABCABDIFCAAQgAQyBQgAEIAEMgUIABCABDIFCAAQgAQyBAgAEB4yBAgAEB4yBAgAEB46BAgAEEM6BggAEAcQHlCCCFiCCGCREWgAcAB4AIABmwGIAZsCkgEDMC4ymAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=WATAY67gOcnv5OUP8KyHsAE&bih=959&biw=958&rlz=1C1CHZN_pt-BRBR1019BR1019",
};
...
const strelitzia = {
  ...
  shadePlant: false,
  partialShadePlant: true,
  image: "./floreios/est01.jpg",
  googleImage: "https://www.google.com/search?q=Strelitzia+reginae&tbm=isch&ved=2ahUKEwjTw4-ji8L8AhUTHLkGHRRlA04Q2-cCegQIABAA&oq=Strelitzia+reginae&gs_lcp=CgNpbWcQAzIFCAAQgAQyBQgAEIAEMgQIABAeMgQIABAeMgQIABAeMgQIABAeMgQIABAeMgQIABAeMgQIABAeMgQIABAeOgQIABBDOgYIABAHEB5Q5QlY5QlgoxJoAHAAeACAAYABiAH4AZIBAzAuMpgBAKABAaoBC2d3cy13aXotaW1nwAEB&sclient=img&ei=ewTAY5OaGJO45OUPlMqN8AQ&bih=959&biw=958&rlz=1C1CHZN_pt-BRBR1019BR1019",
};
...
const pataDeElefante = {
  ...
  shadePlant: false,
  partialShadePlant: true,
  image: "./floreios/pat01.jpg",
  googleImage: "https://www.google.com/search?q=Beaucarnea+recurvata&tbm=isch&ved=2ahUKEwjbvauzi8L8AhVxBbkGHcEoCJkQ2-cCegQIABAA&oq=Beaucarnea+recurvata&gs_lcp=CgNpbWcQAzIFCAAQgAQyBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB4yBAgAEB46BAgAEEM6BggAEAcQHlCdCFidCGD6DmgAcAB4AIABrwGIAaACkgEDMC4ymAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=nQTAY5v7GPGK5OUPwdGgyAk&bih=959&biw=958&rlz=1C1CHZN_pt-BRBR1019BR1019",
};
...
const tresMarias = {
  ...
  shadePlant: false,
  partialShadePlant: true,
  image: "./floreios/trm01.jpg",
  googleImage: "https://www.google.com/search?q=Bougainvillea+sp&tbm=isch&ved=2ahUKEwiBq4vFi8L8AhVUN7kGHQjsAegQ2-cCegQIABAA&oq=Bougainvillea+sp&gs_lcp=CgNpbWcQAzIFCAAQgAQyBQgAEIAEMgUIABCABDIFCAAQgAQyBQgAEIAEMgUIABCABDIFCAAQgAQyBQgAEIAEMgQIABAeMgQIABAeOgQIABBDOgYIABAHEB5QwgdYwgdgiQ9oAHAAeACAAbIBiAGzApIBAzAuMpgBAKABAaoBC2d3cy13aXotaW1nwAEB&sclient=img&ei=wgTAY4HCJtTu5OUPiNiHwA4&bih=959&biw=958&rlz=1C1CHZN_pt-BRBR1019BR1019",
};
...
// busca(allPlants,"Pata")
// busca(allPlants,"Podocarpo")
...
const homepage = document.getElementById("cards").innerHTML
...
function pesquisar () {
  ...
  for(let planta of allPlants){
    const floraLowerCase = planta.flora.toLowerCase()
    const nickLowerCase = planta.nick.toLowerCase()

    if(floraLowerCase.includes(userSearchLowerCase)){
      foundPlants.push(planta.flora)
      console.log(planta.image)
      document.getElementById("cards").innerHTML += `
      <section class="card" id="${planta.flora}">
            <img
              src="${planta.image}"
              alt="imagem de mudas de ${planta.nick}"
            />
            <h2 class="scientificName"><a
                href=${planta.googleImage}
                >${planta.flora}</a
              >
            </h2>
            <p class="nick">${planta.nick}</p>
            <p>Altura: ${planta.saleSize}cm</p>
            <p>Preço: R$ ${planta.salePrice.toFixed(0)},00</p>
            <p>Planta de ${planta.sunnyPlant ? "sol pleno" : ""} ${planta.partialShadePlant ? "meia sombra" : ""} ${planta.shadePlant ? "sombra" : ""}.</p>
          </section>`

    }else if(nickLowerCase.includes(userSearchLowerCase)){
      console.log(planta.image)
      foundPlants.push(planta.flora)
      document.getElementById("cards").innerHTML += `
      <section class="card" id="${planta.flora}">
  ...
  alert(`${userSearch} não encontrado.`)
  }
}

function backToHomepage(){
  cards.innerHTML = homepage
}
