...
//     console.log (leao.array[i])
// }

// for (let j = 0; j < leao.length; j++) {
//     console.log(`Nome ${leao[j].nome.toUpperCase()}\nTempo médio de vidsssssa ${leao[j].tempoMedioDeVida}\n${leao[j].classe}\n${leao[j].array}`)
// }

// function queRetorna(leaorapa) {
//     let string = ""
//     string = leaorapa
//     console.log(string)
// }
...
function nan (celular, sust) {
    let fofo = {}
    for (let i in celular){
       if (celular[i] === sust){
         fofo = celular[i]
         }
    }
