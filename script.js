...
for(let i in greysAnatomy.elencoPrincipal){
    stringGreysAnatomy += greysAnatomy.elencoPrincipal1[i] + " "
}

let = stringLaCasaDePapel = ""
for(let i in laCasaDePapel.elencoPrincipal1){
    stringLaCasaDePapel += laCasaDePapel.elencoPrincipal1[i] + " "
}

let = stringVikings = ""
for(let i in vikings.elencoPrincipal1){
    stringVikings += vikings.elencoPrincipal1[i] + " "
}

let teste = ""
for(let i in vikings[i]){
    teste = i + " "
}
