...
//   const nomeDaComida = cardapio.filter(
//     (cardapioObj) => cardapioObj.nome == nome
//   );
//   alert(`Sua comida pesquisada é o: ${nomeDaComida[0].nome}`);
// }
// //chamada da função que retorna a pesquisa
// retornoPesquisa(cardapio, pesquisa);
...
//   retornarIngredientesSabores(comidas, comidas);
// }
