...
jogo1 = {
    ...
    sinopse: "Link é um jovem da floresta que vê seu lar em perigo e parte em uma jornada para deter um rei maligno e salvar o reino de Hyrule! Para completar sua missão, ele terá que encontrar a princesa Zelda e ajudar outros povos para conseguir reunir os pedaços da Triforce e restabelecer o equilíbrio do mundo!",
    releaseDate: 1998,
    criticReview: 9.9,
    publicReview: 9.1,
...
jogo2 = {
    ...
    sinopse: "A história começa com Link, que ao acordar, se encontra perdido em uma Hyrule devastada. Após cem anos de sono, Link precisa partir em uma aventura para recuperar suas memórias e derrotar todo o mal causado por Calamity Ganon.",
    releaseDate: 2017,
    criticReview: 9.7,
    publicReview: 8.7,
...
jogo3 = {
    ...
    sinopse: "Jogado em um mundo paralelo, Link encontra uma terra em grave perigo. A misteriosa Máscara de Majora causou estragos nos cidadãos da cidade de Termina, mas seu problema mais urgente é a lua caindo em direção ao mundo! Link tem apenas 3 dias, apenas 72 horas, para encontrar uma maneira de parar sua queda.",
    releaseDate: 2000,
    criticReview: 9.5,
    publicReview: 9.1,
    availablePlataform: `${platforms[0]}, ${platforms[1]}`,
