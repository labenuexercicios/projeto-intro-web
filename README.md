...
Semana 4
1. OK Crie uma página HTML, e nesta página, dê um título para sua lista de itens;
2. OK Crie um cabeçalho, uma seção principal, e um footer para a página;
3. OK Na seção principal. Crie duas divisões. Uma deve possuir um input e um botão. A outra, deve possuir sections para criar os itens da lista;
4. OK Crie uma section para cada item da lista;
...
.join()
.toString()
Retornando o array 0 ele retorna como objeto
filter, find, for each,map e até for of.